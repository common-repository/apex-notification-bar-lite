...
* Removed CSS that reset styles of global elements.

= 2.0.4 =
* Fixed issue related to Notification Components.
* Fixed issue related to Header Information Error.
* Backend and Frontend Few CSS refinement work done.

= 2.0.3 =
* Compatibility check with latest Version of WordPress.
* Fixed header information issue.
