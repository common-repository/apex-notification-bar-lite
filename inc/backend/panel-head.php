...
<div class="edn-panel-head">
    <div class="edn-row">
        <div class="edn-head-logo"><?php _e(APEXNBL_TITLE,APEXNBL_TD);?>
         <span>Version <?php echo APEXNBL_VERSION;?></span>
        </div>
        <div class="edn-head-social-link">
            <p class="edn-follow-us"><?php _e('Follow us for new updates',APEXNBL_TD);?></p>
